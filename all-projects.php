...
<head>
<meta charset="utf-8" />
<title><?php echo APPLICATION_TITLE ?> - Project List</title>
    ...
    <div id="wrap">
        ...
        <header>
            ...
            <div class="breadcrumbs">
                ...
                if ($users->isOwner($session->get("userid"))) {
                ?>
                <a class="tip" href="#" title="All Projects"><img src="images/all-projects.png"></a>
            ...
            <div id="main-content" class="project-tasks clearer">
                ...
                <article id="project-tasks">
                    ...
                    <div class="task-header">
                        ...
                        <div class="task-user">
                            <p><a class="tip" id="by-tasks" href="#" title="Sort by project open tasks">Open tasks</a></p>
                        </div>
                    </div>
                    <!-- /project header -->
                    ...
                    <li data-id="<?php echo $openProjects[$i]["id"]; ?>" data-expire="<?php echo $openProjects[$i]["expire"]; ?>" data-created="<?php echo $openProjects[$i]["created"]; ?>" data-tasks="<?php echo $tasks->countOpenTasks($openProjects[$i]["id"]); ?>" data-title="<?php echo $openProjects[$i]["title"]; ?>">
                    ...
                    <div class="task task-bg <?php echo $utilities->setColorClass($openProjects[$i]["expire"]); ?>">
                        ...
                        <div class="task-user">
                            <p><?php echo $tasks->countOpenTasks($openProjects[$i]["id"]); ?></p>
                        </div>
                    </div>
                    <!-- /project -->
                    ...
                    <div class="task task-bg-closed">
                        <div class="task-title">
                            <p><a class="tip" href="project.php?pid=<?php echo $closedProjects[$i]["id"]; ?>" role="link" title="<?php echo strip_tags($closedProjects[$i]["description"]); ?>"><?php echo $closedProjects[$i]["title"]; ?></a></p>
                        </div>
                    </div>
                    <!-- /project -->
