...
<head>
<meta charset="utf-8" />
<title><?php echo APPLICATION_TITLE ?> - My Loose Nails</title>
    ...
    <div id="wrap">
        ...
        <header>
            ...
            <div id="top-panel">
                ...
                <!-- add assignment -->
                <div class="add">
                    <a id="add-project-button" class="tip" href="add-todo.php" role="link" title="Add new loose task">Add loose task</a>
                </div>
                <!-- /add assignment -->
                <?php } ?>
            ...
            <div id="main-content" class="project-tasks clearer">
                ...
                <article id="project-tasks">
                    ...
                    <div id="add-first-task" style="margin-bottom: 20px;">
                        <a class="blue-button default-button shadow tip" role="button" href="#" title="There are no assignments for you at this moment" onClick="return false;">There are no assignments for you</a>
                    </div>
                    <?php 
                    } 
                    ?>
